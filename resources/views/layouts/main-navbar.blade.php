            ...
            <div class="flex-1 flex items-center justify-center sm:justify-start">
                <div class="flex-shrink-0 flex items-center">
                    <a href="{{ route('home.index') }}"
                        class="bg-white py-1 px-2 inline-block h-14 md:h-24"
                        :class="{ 'opacity-90': route == 'home.index' }">
                        <img class="block lg:block h-full w-auto"
                            src="/images/logo_pearl_2.png"
                            alt="Pearl Real Estate Logo">
                    </a>
