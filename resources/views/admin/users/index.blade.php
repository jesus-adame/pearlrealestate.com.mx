            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-md">
                <div class="bg-white border-b border-gray-200">
                    <table class="table-fixed w-full">
                        <thead>
                            <tr>
                                <th class="text-white bg-gray-800 p-2 w-40 text-center">Nombre</th>
                                <th class="text-white bg-gray-800 p-2 w-40 text-center">Apellidos</th>
                                <th class="text-white bg-gray-800 p-2 w-40">Correo</th>
