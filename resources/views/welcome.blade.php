<x-guest-layout>
    <div class="mx-auto" style="max-width: 3000px">
                ...
                <ul class="splide__list">
                    <li class="splide__slide">
                        <div class="overflow-hidden relative" style="max-height: 700px; min-height: 700px">
                            ...
                            <div class="absolute top-0 bottom-0 right-0 left-0 m-auto max-w-7xl h-52 p-5">
                                <p class="text-4xl text-gray-50 uppercase mb-4" style="text-shadow: 1px 2px 2px #000">
                                    Encuentra tu lugar ideal</p>
    ...
    <div class="relative z-10 bg-gray-50 w-1/2 mx-auto p-10 shadow-md border-t-8 border-yellow-500 rounded"
